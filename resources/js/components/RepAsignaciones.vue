  ...
  methods: {
    ...
    registrarAsignacion(){
      if(this.cod_resp == 0){
        ...
        let me = this;
        me.pdf ='http://mindef6.test/actual/repAsignaciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&codcont='+ me.codcont + '&unidad='+me.idunidad;
        me.modalpdf = 1;
      }
      else{
        let me = this;
        me.pdf ='http://mindef6.test/actual/repAsignaciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&data='+ me.checkContables + '&unidad='+me.idunidad;
        me.modalpdf = 1;
      }
    },
    cerrarModalpdf(){
    ...
    registrarDevolucion(){
      if(this.cod_resp == 0){
        ...
        let me = this;
        me.pdf='http://mindef6.test/actual/repDevoluciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&codcont='+ me.codcont  + '&unidad=' + me.idunidad;
        me.modalpdf = 1;
      }
      else{
        let me = this;
        me.pdf='http://mindef6.test/actual/repDevoluciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&data='+ me.checkContables  + '&unidad=' + me.idunidad;
        me.modalpdf = 1;
      }
    },
